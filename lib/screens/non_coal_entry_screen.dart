...
class NonCoalEntryScreen extends StatefulWidget {
  ...
  @override
  _NonCoalEntryScreenState createState() =>
      _NonCoalEntryScreenState();
}
...
class _NonCoalEntryScreenState extends State<NonCoalEntryScreen> {
  ...
  void initState() {
    ...
    _process = false;
    _count = 1;
    final tempCoalBox = Hive.box('noncoal')
        .values;
    if(tempCoalBox.isNotEmpty){
      setState(() {
  ...
  void AddData() {
    if (_formKey.currentState!.validate()  && _date != null) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => NonCoalHistoryScreen(coalModel: coalModel)));
    } else {
