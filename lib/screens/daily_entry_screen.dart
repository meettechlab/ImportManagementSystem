...
class _DailyEntryScreenState extends State<DailyEntryScreen> {
  ...
  void AddData() {
    if (_formKey.currentState!.validate() &&
      ...
      if(_chosenCost == "Coal"){
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => DailyCoalScreen() ));
      }else if(_chosenCost == "Stone"){
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => DailyStoneScreen() ));
      }else{
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => DailyCrusherScreen() ));
      }
