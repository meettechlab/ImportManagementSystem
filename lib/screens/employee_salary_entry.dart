  ...
  void AddData() {
    if (_formKey.currentState!.validate() && _date != null) {
      ...
      final employeeModel = Employee(
          ...
          _invoice.toString(),
      widget.employeeModel.contact,
      widget.employeeModel.address,DateFormat('MMM-yyyy').format(_date!));
      ...
      Navigator.pushReplacement(
          ...
          builder: (context) => SingleEmployeeScreen(employeeModel: widget.employeeModel)));
    } else {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
