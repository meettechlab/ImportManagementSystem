...
class _CreateEmployeeScreenState extends State<CreateEmployeeScreen> {
  ...
  void AddData() {
    if (_formKey.currentState!.validate() && _date != null) {
      ...
      final _invoice = "1";
      final employeeModel = Employee(DateFormat('dd-MMM-yyyy').format(_date!), nameEditingController.text, postEditingController.text, salaryEditingController.text, salaryAdvancedEditingController.text, "0", "0", remarksEditingController.text, _invoice, contactEditingController.text,addressEditingController.text,DateFormat('MMM-yyyy').format(_date!));
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => SingleEmployeeScreen(employeeModel: employeeModel)));
    }else{
