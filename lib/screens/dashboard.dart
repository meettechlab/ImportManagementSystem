                ...
                children: [
                  ...
                  getImageButton(() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => StoneSaleScreen()));
                  },
                      'assets/images/stone.jpg',
                    'Stone Border Sale',
                  ),
                  ...
                  getImageButton(() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => CrusherStockSScreen()));
                  },
                  ...
                  getImageButton(() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => CrusherStockTScreen()));
                  },
                    'assets/images/crusher.jpg',
                ...
                children: [
                  getImageButton(() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => CrusherSaleSScreen()));
                  },
                      'assets/images/crusher.jpg',
                  ...
                  getImageButton(() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => CrusherSaleTScreen()));
                  },
                    'assets/images/crusher.jpg',
                  ...
                  getImageButton(() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => CoalLCListScreen()));
                  },
                ...
                children: [
                  getImageButton(() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => CoalSaleScreen()));
                  },
                    'assets/images/Coal.jpg',
                    'Coal Sale',
                  ),
                  ...
                  getImageButton(() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => DailyCostScreen()));
                  },
